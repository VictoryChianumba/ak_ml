...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        B, T, C = x.size() # Batch sizer, sequence length, embedding dimensionality 
        # Calculate query, key and value for all heads in the batch and move head forward to be the batch
